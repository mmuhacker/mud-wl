...
<p align="center">
  <img src="img/wl5.png" width="600" alt="نص إستعلام ip"><br>
  <em>الشكل 6: نص إستعلام ip</em>
</p><br>
...
راجع ملف [الترخيص LICENSE](https://github.com/mmuhacker/mud-wl/blob/main/LICENSE.md) للنص الكامل.
